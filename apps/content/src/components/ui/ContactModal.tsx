  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
      <div className="w-full max-w-lg rounded-lg bg-white p-6">
        ...
        <p className="text-sm text-muted-foreground mb-4">Completa algunos datos y te contactamos por WhatsApp, email y CRM.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-2 justify-end">
            ...
            <ShimmerButton type="submit" className="px-6" shimmerColor="#ffffff">{submitting ? 'Enviando...' : 'Enviar y Contactar'}</ShimmerButton>
          </div>
        </form>
      </div>
    </div>
